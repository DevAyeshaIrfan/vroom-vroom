...
COOLDOWN_TIME equ 15            ; Frames to wait between lane changes

collision_happened: db 0         ; Flag for collision detection
spark_timer: dw 0               ; Timer for spark animation
...
;========================================================
; MAIN GAME LOOP - WITH COLLISION HANDLING
;========================================================
game_loop:
...
.handle_collision:
    ...
    ; Check if spark animation is done
    cmp word [spark_timer], 0
    jne game_loop               ; Continue showing sparks
    
    ; Spark animation done, trigger game over
